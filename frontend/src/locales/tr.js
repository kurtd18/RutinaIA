...
export default {
  ...
  "This browser doesn't support passkeys — you can still use RutinaIA locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de RutinaIA’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install RutinaIA as a full-screen app.': 'ile RutinaIA’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'A small file a friend imports into their own RutinaIA — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi RutinaIA\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
  ...
  'Your server': 'Sunucun',
  'Synced with your RutinaIA server.': 'RutinaIA sunucunla senkronize edildi.',
  ...
  'Sync this device to your own self-hosted RutinaIA instead.': "Bu cihazı bunun yerine kendi self-hosted RutinaIA'inle senkronize et.",
  'Pair the mobile app': 'Mobil uygulamayı eşleştir',
  'Connect the RutinaIA app on your phone to this account.': 'Telefonundaki RutinaIA uygulamasını bu hesaba bağla.',
  'Could not generate a code': 'Kod oluşturulamadı',
  'On the RutinaIA app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'RutinaIA uygulamasında “Sunucuma bağlan”ı seç, ardından bu adresi ve aşağıdaki kodu gir. 5 dakika içinde sona erer.',
  'Enter your server address and the code': 'Sunucu adresini ve kodu gir',
  'Connected': 'Bağlandı',
  'Could not connect': 'Bağlanılamadı',
  'Open Settings → “Pair the mobile app” on the RutinaIA site you’re already signed into, then enter its address and the code shown there.': 'Zaten oturum açtığın RutinaIA sitesinde Ayarlar → “Mobil uygulamayı eşleştir”i aç, ardından adresini ve orada gösterilen kodu gir.',
  'Server address (e.g. gym.example.com)': 'Sunucu adresi (ör. gym.example.com)',
  'Pairing code': 'Eşleştirme kodu',
  'Connecting…': 'Bağlanıyor…',
  'Connect': 'Bağlan',
  'How do you want to use RutinaIA?': "RutinaIA'i nasıl kullanmak istersin?",
  'Use on this device': 'Bu cihazda kullan',
  'Local keeps everything on this phone. Connecting syncs to your own RutinaIA server instead — you can switch later in Settings.': "Yerel, her şeyi bu telefonda tutar. Bağlanmak ise bunun yerine kendi RutinaIA sunucunla senkronize eder — bunu daha sonra Ayarlar'dan değiştirebilirsin.",

...
export default {
  ...
  "This browser doesn't support passkeys — you can still use RutinaIA locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst RutinaIA trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install RutinaIA as a full-screen app.': 'um RutinaIA als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if RutinaIA is closed.': 'Pausen-Timer-Alarm, auch wenn RutinaIA geschlossen ist.',
  'Workout day reminder': 'Trainingstag-Erinnerung',
  'Streak reminder': 'Serien-Erinnerung',
  'Days before reminding': 'Tage bis zur Erinnerung',
  ...
  'A small file a friend imports into their own RutinaIA — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes RutinaIA importiert — nur Routinen, keine Workouts oder Wiegungen.',
  ...
  'Reload RutinaIA': 'RutinaIA neu laden',
  ...
  'Synced with your RutinaIA server.': 'Mit deinem RutinaIA-Server synchronisiert.',
  'Disconnect': 'Trennen',
  ...
  'Sync this device to your own self-hosted RutinaIA instead.': 'Dieses Gerät stattdessen mit deinem eigenen self-hosted RutinaIA synchronisieren.',
  'Pair the mobile app': 'Mobile App koppeln',
  'Connect the RutinaIA app on your phone to this account.': 'Verbinde die RutinaIA-App auf deinem Handy mit diesem Konto.',
  'Could not generate a code': 'Code konnte nicht erstellt werden',
  'On the RutinaIA app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'Wähle in der RutinaIA-App „Mit meinem Server verbinden“, gib dann diese Adresse und den Code unten ein. Er läuft in 5 Minuten ab.',
  'Enter your server address and the code': 'Serveradresse und Code eingeben',
  'Connected': 'Verbunden',
  'Could not connect': 'Verbindung fehlgeschlagen',
  'Open Settings → “Pair the mobile app” on the RutinaIA site you’re already signed into, then enter its address and the code shown there.': 'Öffne auf der RutinaIA-Seite, bei der du bereits angemeldet bist, Einstellungen → „Mobile App koppeln“, und gib dann deren Adresse und den dort angezeigten Code ein.',
  'Server address (e.g. gym.example.com)': 'Serveradresse (z. B. gym.example.com)',
  'Pairing code': 'Kopplungscode',
  'Connecting…': 'Verbinde …',
  'Connect': 'Verbinden',
  'How do you want to use RutinaIA?': 'Wie möchtest du RutinaIA nutzen?',
  'Use on this device': 'Auf diesem Gerät nutzen',
  'Local keeps everything on this phone. Connecting syncs to your own RutinaIA server instead — you can switch later in Settings.': 'Lokal behält alles auf diesem Handy. Verbinden synchronisiert stattdessen mit deinem eigenen RutinaIA-Server — du kannst das später in den Einstellungen ändern.',

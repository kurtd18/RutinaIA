...
export default {
  ...
  "This browser doesn't support passkeys — you can still use RutinaIA locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar RutinaIA localmente en este dispositivo.',
  ...
  'to install RutinaIA as a full-screen app.': 'para instalar RutinaIA como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if RutinaIA is closed.': 'Avisos del temporizador de descanso, incluso con RutinaIA cerrado.',
  'Workout day reminder': 'Recordatorio de día de entrenamiento',
  'Streak reminder': 'Recordatorio de racha',
  'Days before reminding': 'Días antes de recordar',
  ...
  'A small file a friend imports into their own RutinaIA — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio RutinaIA: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload RutinaIA': 'Recargar RutinaIA',
  ...
  'Synced with your RutinaIA server.': 'Sincronizado con tu servidor de RutinaIA.',
  ...
  'Sync this device to your own self-hosted RutinaIA instead.': 'Sincroniza este dispositivo con tu propio RutinaIA self-hosted.',
  'Pair the mobile app': 'Emparejar la app móvil',
  'Connect the RutinaIA app on your phone to this account.': 'Conecta la app de RutinaIA en tu móvil a esta cuenta.',
  'Could not generate a code': 'No se pudo generar un código',
  'On the RutinaIA app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'En la app de RutinaIA, elige «Conectar a mi servidor», luego introduce esta dirección y el código de abajo. Caduca en 5 minutos.',
  ...
  'Open Settings → “Pair the mobile app” on the RutinaIA site you’re already signed into, then enter its address and the code shown there.': 'En Ajustes → «Emparejar la app móvil» del sitio de RutinaIA en el que ya has iniciado sesión, luego introduce su dirección y el código que aparece ahí.',
  'Server address (e.g. gym.example.com)': 'Dirección del servidor (p. ej. gym.example.com)',
  'Pairing code': 'Código de emparejamiento',
  'Connecting…': 'Conectando…',
  'Connect': 'Conectar',
  'How do you want to use RutinaIA?': '¿Cómo quieres usar RutinaIA?',
  'Use on this device': 'Usar en este dispositivo',
  'Local keeps everything on this phone. Connecting syncs to your own RutinaIA server instead — you can switch later in Settings.': 'Local mantiene todo en este teléfono. Conectar sincroniza con tu propio servidor de RutinaIA — puedes cambiarlo luego en Ajustes.',

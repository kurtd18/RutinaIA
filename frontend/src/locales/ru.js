...
export default {
  ...
  "This browser doesn't support passkeys — you can still use RutinaIA locally on this device.": 'Этот браузер не поддерживает ключи доступа — но RutinaIA можно использовать локально на этом устройстве.',
  ...
  'to install RutinaIA as a full-screen app.': 'чтобы установить RutinaIA как полноэкранное приложение.',
  ...
  'A small file a friend imports into their own RutinaIA — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой RutinaIA — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload RutinaIA': 'Перезагрузить RutinaIA',
  ...
  'Synced with your RutinaIA server.': 'Синхронизировано с вашим сервером RutinaIA.',
  ...
  'Sync this device to your own self-hosted RutinaIA instead.': 'Синхронизировать это устройство с вашим собственным self-hosted RutinaIA.',
  'Pair the mobile app': 'Сопряжение мобильного приложения',
  'Connect the RutinaIA app on your phone to this account.': 'Подключите приложение RutinaIA на телефоне к этому аккаунту.',
  'Could not generate a code': 'Не удалось создать код',
  'On the RutinaIA app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'В приложении RutinaIA выберите «Подключиться к моему серверу», затем введите этот адрес и код ниже. Он действителен 5 минут.',
  'Enter your server address and the code': 'Введите адрес вашего сервера и код',
  'Connected': 'Подключено',
  'Could not connect': 'Не удалось подключиться',
  'Open Settings → “Pair the mobile app” on the RutinaIA site you’re already signed into, then enter its address and the code shown there.': 'В Настройках → «Сопряжение мобильного приложения» на сайте RutinaIA, где вы уже вошли, введите его адрес и показанный там код.',
  'Server address (e.g. gym.example.com)': 'Адрес сервера (например, gym.example.com)',
  'Pairing code': 'Код сопряжения',
  'Connecting…': 'Подключение…',
  'Connect': 'Подключить',
  'How do you want to use RutinaIA?': 'Как вы хотите использовать RutinaIA?',
  'Use on this device': 'Использовать на этом устройстве',
  'Local keeps everything on this phone. Connecting syncs to your own RutinaIA server instead — you can switch later in Settings.': 'Локальный режим хранит всё на этом телефоне. Подключение вместо этого синхронизирует данные с вашим сервером RutinaIA — вы сможете изменить это позже в Настройках.',

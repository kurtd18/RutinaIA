...
export default {
  ...
  "This browser doesn't support passkeys — you can still use RutinaIA locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर RutinaIA लोकली इस्तेमाल कर सकते हैं।',
  ...
  'to install RutinaIA as a full-screen app.': 'से RutinaIA को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'A small file a friend imports into their own RutinaIA — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने RutinaIA में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'Reload RutinaIA': 'RutinaIA फिर से लोड करें',
  ...
  'Synced with your RutinaIA server.': 'आपके RutinaIA सर्वर के साथ सिंक हो गया।',
  ...
  'Sync this device to your own self-hosted RutinaIA instead.': 'इसके बजाय इस डिवाइस को अपने खुद के सेल्फ़-होस्टेड RutinaIA से सिंक करें।',
  'Pair the mobile app': 'मोबाइल ऐप पेयर करें',
  'Connect the RutinaIA app on your phone to this account.': 'अपने फ़ोन पर RutinaIA ऐप को इस अकाउंट से जोड़ें।',
  'Could not generate a code': 'कोड जनरेट नहीं हो सका',
  'On the RutinaIA app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'RutinaIA ऐप में "मेरे सर्वर से कनेक्ट करें" चुनें, फिर यह पता और नीचे दिया कोड डालें। यह 5 मिनट में समाप्त हो जाता है।',
  ...
  'Open Settings → “Pair the mobile app” on the RutinaIA site you’re already signed into, then enter its address and the code shown there.': 'जिस RutinaIA साइट में आप पहले से साइन इन हैं, वहाँ सेटिंग्स → "मोबाइल ऐप पेयर करें" खोलें, फिर उसका पता और वहाँ दिखा कोड डालें।',
  'Server address (e.g. gym.example.com)': 'सर्वर का पता (जैसे gym.example.com)',
  'Pairing code': 'पेयरिंग कोड',
  'Connecting…': 'कनेक्ट हो रहा है…',
  'Connect': 'कनेक्ट करें',
  'How do you want to use RutinaIA?': 'आप RutinaIA का उपयोग कैसे करना चाहते हैं?',
  'Use on this device': 'इस डिवाइस पर उपयोग करें',
  'Local keeps everything on this phone. Connecting syncs to your own RutinaIA server instead — you can switch later in Settings.': 'लोकल सब कुछ इसी फ़ोन पर रखता है। कनेक्ट करने पर इसके बजाय आपके अपने RutinaIA सर्वर से सिंक होता है — इसे बाद में सेटिंग्स में बदला जा सकता है।',
